...
if (isset($_GET['search_letter'])) {
    $searchLetter = $_GET['search_letter'] . '%';
    $sql = "SELECT * FROM services WHERE service_name LIKE :searchLetter ORDER BY service_name ASC";
    $query = $pdo->prepare($sql);
    $query->execute(['searchLetter' => $searchLetter]);
    ...
    if ($query->rowCount() > 0) {
        foreach ($results as $result) {
            ...
            echo '<div class="col-md-6 col-lg-4 my-3 service-card">';
            echo '<div class="card">';
