...
<head>
    ...
    <style>
        ...
        #popUpReservations {
            ...
            padding: 20px;
            height:700px;
            max-width: 90%; /* Maksimalna širina pop-up prozora */
            width: auto; /* Automatsko prilagođavanje širine sadržaju */
            overflow-y: auto;
        }

        /* Stil za tabelu unutar pop-up prozora */
        #table_cancel {
            max-height: 300px; /* Maksimalna visina tabele */
            overflow-y: auto; /* Omogućava vertikalno skrolovanje ako je potrebno */
        }
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="bookProcedureModalLabel">Book Procedure</h5>
