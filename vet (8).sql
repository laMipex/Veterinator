...
(18, 16, NULL, 'Roki', 6, 'Pas', 'German Shepard', '20240610142408-Roki.jpg');
...
(1, 'Surgery', 'Most aggressive procedure, only if necessary.', NULL, '10:27:02', 500, NULL, NULL, NULL),
(2, 'Dental', 'Dental hygiene and systematic checkup.', '9490.jpg', '00:30:00', 50, NULL, NULL, NULL),
(3, 'Anesthesia', 'Anesthesia is always safe.', NULL, '00:15:00', 20, NULL, NULL, NULL),
(4, 'Vaccinations', 'Vaccination for everything', NULL, '00:05:00', 30, NULL, NULL, NULL),
(5, 'Sterilization', 'Very efficient', '20240608222847-Sterilization.jpg', '30 min', NULL, NULL, NULL, NULL),
(13, 'Proba', 'hhh', NULL, '30 min', NULL, NULL, NULL, NULL),
(14, 'Test', 'proba', '20240609000241-Test.jpg', '30 min', NULL, NULL, NULL, NULL),
(15, 's', 's', '20240610130957-s.jpg', 's', NULL, NULL, NULL, NULL),
(16, 'd', 'd', '20240610131135-d.jpg', 'd', NULL, NULL, NULL, NULL);
...
INSERT INTO `vet` (`id_vet`, `vet_fname`, `vet_lname`, `vet_email`, `vet_password`, `vet_phone`, `specialization`, `city`, `active`, `registration_token`, `registration_expires`, `is_banned`, `forgotten_password_token`, `forgotten_password_expires`, `registration_date`, `work_start`, `work_end`) VALUES
(1, 'Nikola', 'Spasojević', 'nikolaspasojevic@gmail.com', '$2y$10$dAOaSNOipGq2B/l.ofRbtu2vwzsTZPgy.y8O4AEiHp8H.N7knykIa', 644544544, '', '', 1, '', '0000-00-00 00:00:00', 0, NULL, NULL, '2024-06-09 14:49:37', '00:00:00', '00:00:00');
...
ALTER TABLE `user_reservation`
  ...
  ADD CONSTRAINT `user_reservation_ibfk_3` FOREIGN KEY (`id_service`) REFERENCES `services` (`id_service`);
