...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2024 at 11:55 PM
...
(18, 16, 1, 'Roki', 6, 'Pas', 'German Shepard', '20240610142408-Roki.jpg');
...
CREATE TABLE `reservations` (
  ...
  `code verified` smallint(1) NOT NULL DEFAULT 0,
...
INSERT INTO `reservations` (`id_reservation`, `id_pet`, `id_service`, `id_vet`, `reservation_date`, `reservation_time`, `treatment_price`, `code`, `code verified`, `reservation_added`, `service_duration`) VALUES
(1, 18, 5, 1, '2024-06-20', '09:00:00', 500, '', 0, '2024-06-12 22:44:23', '00:30:00'),
(3, 18, 5, 1, '2024-06-21', '09:00:00', 50, '', 0, '2024-06-12 22:48:54', '00:30:00'),
(4, 18, 1, 1, '2024-06-20', '10:00:00', 500, '', 0, '2024-06-12 22:51:38', '00:59:00'),
(5, 3, 5, 2, '2024-06-20', '07:30:00', 50, '', 0, '2024-06-16 18:01:43', '00:30:00'),
(6, 3, 5, 2, '2024-06-26', '07:00:00', 50, '', 0, '2024-06-16 18:59:56', '00:30:00'),
(7, 3, 1, 1, '2024-06-17', '09:30:00', 500, '', 0, '2024-06-16 19:03:29', '00:59:00'),
(8, 17, 1, 1, '2024-06-20', '08:00:00', 500, '', 0, '2024-06-16 20:11:25', '00:59:00'),
(9, 17, 1, 2, '2024-06-25', '08:30:00', 500, '', 0, '2024-06-16 20:19:45', '00:59:00'),
(11, 17, 5, 1, '2024-06-18', '08:30:00', 50, '', 0, '2024-06-16 23:11:24', '00:30:00'),
(12, 17, 1, 1, '2024-06-21', '08:30:00', 500, '', 0, '2024-06-16 23:30:57', '00:59:00'),
(13, 2, 5, 1, '2024-06-20', '09:30:00', 50, '', 0, '2024-06-17 10:30:50', '00:30:00'),
(14, 2, 5, 2, '2024-06-18', '08:00:00', 50, 'XmzncK', 0, '2024-06-17 11:39:08', '00:30:00'),
(15, 2, 1, 2, '2024-06-25', '07:00:00', 500, 'RwpXth', 0, '2024-06-17 11:42:37', '00:59:00');
...
CREATE TABLE `users` (
  `id_user` int(11) NOT NULL,
  `vet_fname` varchar(25) NOT NULL,
  `vet_lname` varchar(50) NOT NULL,
  `vet_phone` int(20) NOT NULL,
  `age` int(3) DEFAULT NULL,
  `vet_email` varchar(75) NOT NULL,
...
INSERT INTO `users` (`id_user`, `vet_fname`, `vet_lname`, `vet_phone`, `age`, `vet_email`, `user_password`, `active`, `registration_token`, `registration_expires`, `is_banned`, `forgotten_password_token`, `forgotten_password_expires`, `registration_date`, `negative_points`) VALUES
(16, 'Milana', 'ivanovic', 644544544, NULL, 'sabovljevmilanaaa@gmail.com', '$2y$10$Qcxn0/iIEkCExb5Yx4dVE.cbWg5zL7Q3eJo2ZtJsMdXhV5YmKVy/e', 1, '', '0000-00-00 00:00:00', 0, '', '0000-00-00 00:00:00', '2024-06-09 01:51:40', 0),
...
(22, 'Mihajlo', 'Baranovski', 628480677, 20, 'mihajlobar03@gmail.com', '$2y$10$X2g1JLpfGuUsOwcsRp3A/.rTQZnxVL.XEkbp.YT/Dzlvyn1.GX6lK', 1, '', '0000-00-00 00:00:00', 0, NULL, NULL, '2024-06-23 12:18:02', 0),
...
INSERT INTO `vet` (`id_vet`, `vet_fname`, `vet_lname`, `vet_email`, `vet_password`, `vet_vet_phone`, `specialization`, `city`, `active`, `registration_token`, `registration_expires`, `is_banned`, `forgotten_password_token`, `forgotten_password_expires`, `registration_date`, `work_start`, `work_end`) VALUES
(1, 'Nikola', 'Spasojević', 'nikolaspasojevic@gmail.com', '$2y$10$dAOaSNOipGq2B/l.ofRbtu2vwzsTZPgy.y8O4AEiHp8H.N7knykIa', 644544544, 'Emergency and critical care', '', 1, '', '0000-00-00 00:00:00', 0, NULL, NULL, '2024-06-11 15:42:24', '08:00:00.0000', '16:00:00.0000'),
(2, 'Ivana', 'Milivojević', 'ivanamilivojevic@gmail.com', '$2y$10$Qcxn0/iIEkCExb5Yx4dVE.cbWg5zL7Q3eJo2ZtJsMdXhV5YmKVy/e', 654544541, 'General vet', 'Belgrade', 1, '', NULL, 0, NULL, NULL, '2024-06-16 17:43:52', '07:00:00.0000', '15:00:00.0000'),
(3, 'Mi', 'Bar', 'mibar@gmail.com', '$2y$10$d5Tqu2/AjG99iNFco3EtmevlmkyeVf6S20Q3mhmWSGVuMRupjnf42', 628480677, '', '', 1, '', '0000-00-00 00:00:00', 0, NULL, NULL, '2024-06-23 23:49:46', '00:00:00.0000', '00:00:00.0000');
